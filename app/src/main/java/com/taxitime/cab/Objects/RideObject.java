package com.taxitime.cab.Objects;
...
import com.taxitime.cab.Utils.SendNotification;
import com.taxitime.cab.Utils.Utils;
        ...
        try {
          ...
          //  dialog.setContentView(R.layout.dialog_ride_review);
           ...
           // RatingBar mRate = dialog.findViewById(R.id.rate);
            ...
            ImageView mImage = dialog.findViewById(R.id.profile_image);
